...
### Task 1
Construction of new face expressions according to Linear and Differential Interpolation having a dataset of ten
3D models with different facial expressions as a blendshape base. User can change in real-time the weights of the base expressions producing new face expressions.
